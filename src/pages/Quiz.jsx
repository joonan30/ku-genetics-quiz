...
export default function Quiz() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <button onClick={() => window.location.reload()} className="px-4 py-2 bg-crimson-800 text-white rounded-lg hover:bg-crimson-900">
            Retry
          </button>
        </div>
      </div>
  ...
  if (!stage || questions.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <div className="inline-block w-8 h-8 border-4 border-crimson-200 border-t-crimson-800 rounded-full animate-spin" />
